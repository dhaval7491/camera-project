    ...
    <form id="createTrackableForm" method="POST" enctype="multipart/form-data" class="mt-[10px]">
        ...
        <div class="space-y-4">
            ...
            <div class="flex flex-wrap mb-[30px]">
                ...
                <div class="lg:w-4/6 w-full">
                    <div id="addLinkedObjectsContainer" class="flex flex-col gap-2">
                        <div class="flex align-middle input-group">
                            <input type="text" name="linked_objects[]" class="h-[44px] focus-visible:outline-none w-full border-[1px] rounded-[14px] border-[#EBEBEB] border-solid bg-white p-[7px] text-[#7A86A1] text-[14px] mr-[10px]" placeholder="Enter Type" oninput="checkAddInput(this)">
...
<script>
    ...
    function addNewField(addBtn) {
        ...
        newInput.oninput = function() { checkAddInput(this); };
        ...
        let container = document.getElementById('addLinkedObjectsContainer');
    ...
    function toggleAddStatus(button) {
