...
<div class="pl-[30px]">
    <div class="form-list">
                ...
                <div class="sm:w-6/6 md:w-3/6 lg:w-3/6 w-full">
                    <div class="table-filter lg:float-right md:float-right sm:float-left xs:float-left">
                        <ul class="list-inline list-unstyled flex">
                            <!-- <li><p class="manrope-medium text-[15px]  px-[10px] mt-[10px] mr-[15px]">< Back</p></li> -->
                            ...
                            <li class="list-inline-item mr-[15px]">
                                <div class="relative flex items-center">
                                    ...
                                    <button id="search-toggle"
                                        class="p-[13px] rounded-[7px] border border-[#EBEBEB] ml-2 z-[9)}}" class="w-[16px]">
                                    </button>
                                </div>
                            </li>
                            <li class="list-inline-item mr-[15px]">
        ...
        <div class="table-filter-block mt-[20px]">
            <div class="flex">
                <p class="flex items-center w-[150px] manrope-medium text-[#000] text-[16px]"><img class="w-[20px] object-contain mr-[10px]" src="{{ asset('admin-theme/assets/images/filter-by.png')}}"> Filter By:</p>
                ...
                <div x-data="{ 
                                            ...
                                            search: '', 
                                            selected: 'People', 
                                            options: ['People 1', 'People 2', 'People 3', 'People 4'],
                                            selectedOptions: [] 
                                        }" class="relative">
                    ...
                    <table class="min-w-full leading-normal w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 whitespace-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white transition duration-300 ease-in-out hover:bg-[#ededed]">
                                ...
                                <td>
                                    <div class="people-profile flex justify-center"><img src="{{ asset('admin-theme/assets/images/people-1.png')}}" class="w-[30px] h-[30px] object-contain"><img src="{{ asset('admin-theme/assets/images/people-2.png')}}" class="ml-[-10px]"><img src="{{ asset('admin-theme/assets/images/people-3.png')}}" class="ml-[-10px]"><img src="{{ asset('admin-theme/assets/images/people-4.png')}}" class="ml-[-10px]"><span class="bg-[#437651] text-white w-[30px] h-[30px] rounded-[20px] p-[5px] manrope-medium">2+</span></div>
                                </td>
                                <td class="flex justify-center relative">
                                    <span>
                                        <a href="#"><img src="{{ asset('admin-theme/assets/images/edit-report.png')}}" class="w-[21px] mr-[20px]" onclick="toggleModalc()"></a>
                                    </span>
                                    <span>
                            ...
                            <!-- <tr class="bg-[#f8f8f8] transition duration-300 ease-in-out hover:bg-[#ededed]">
                                <th scope="row"
                                    class="px-[20px] py-[20px] text-gray-900 whitespace-nowrap flex">
                                    <div class="">
                                        <span class="text-center inline-block w-[47px] h-[47px] mr-[10px] text-[18px] bg-gradient-to-b from-[#F99C43] to-[#F97C59] text-[#fff] manrope-semibold rounded-[6px] py-[10px] px-[10px]">LT</span>
                                    </div>
                                    <div class="text-[#344563] text-[15px] manrope-regular cursor-pointer mt-[10px]" onclick="document.location='project.html'">
                                        London TechNova Solutions
                                    </div>
                                </th>
                                <td class="px-[20px] py-[20px] text-center text-[#344563] text-[16px] manrope-medium">Jan 08 - 2024 </td>
                                <td class="px-[20px] py-[20px] text-center text-[#344563] text-[16px] manrope-medium">London</td>
                                ...
                                <td>
                                    <div class="people-profile flex justify-center"><img src="assets/images/people-1.png" class="w-[30px] h-[30px] object-contain"><img src="assets/images/people-2.png" class="ml-[-10px]"><img src="assets/images/people-3.png" class="ml-[-10px]"><img src="assets/images/people-4.png" class="ml-[-10px]"><span class="bg-[#437651] text-white w-[30px] h-[30px] rounded-[20px] p-[5px] manrope-medium">2+</span></div>
                                </td>
                                <td class="flex justify-center relative">
                                    <span>
                                        <a href="#"><img src="assets/images/edit-report.png" class="w-[21px] mr-[20px]" onclick="toggleModalc()"></a>
                                    </span>
                                    <span>
                                    ...
                                    <div class="dot-drop absolute bg-white tab-shadow rounded-md hidden top-[30px] right-[60px] w-[170px] p-[10px] z-[8]">
                                        <ul>
                                            <li class="py-[5px]"><a href="#" class="flex text-[#344563] text-[16px] manrope-medium">
                                                    <img src="assets/images/project.png" class="w-[16px] mr-[11px] object-contain">
                                                    <p>Add Project</p>
                                                </a></li>
                                            <li class="py-[5px]"><a href="#" class="flex text-[#344563] text-[16px] manrope-medium">
                            ...
                            <tr class="bg-white transition duration-300 ease-in-out hover:bg-[#ededed]">
                                <th scope="row"
                                    class="px-[20px] py-[20px] text-gray-900 whitespace-nowrap flex">
                                    <div class="">
                                        <span class="text-center inline-block w-[47px] h-[47px] mr-[10px] text-[18px] bg-gradient-to-b from-[#FFB6DE] to-[#f880c2] text-[#fff] manrope-semibold rounded-[6px] py-[10px] px-[10px]">BT</span>
                                    </div>
                                    <div class="text-[#344563] text-[15px] manrope-regular cursor-pointer mt-[10px]" onclick="document.location='project.html'">
                                        ByteCore Technologies
                                    </div>
                                </th>
                                <td class="px-[20px] py-[20px] text-center text-[#344563] text-[16px] manrope-medium">Jan 08 - 2024 </td>
                                <td class="px-[20px] py-[20px] text-center text-[#344563] text-[16px] manrope-medium">London</td>
