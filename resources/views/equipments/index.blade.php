            ...
            <div class="flex flex-wrap">
                <div class="sm:w-6/6 md:w-3/6 lg:w-3/6 w-full flex">
                    <p class="inline-block manrope-medium text-[15px]  px-[0px] mt-[15px] mr-[15px] text-[#437651] underline">
                        < Back</p>
                            <h3 class="manrope-medium text-[#344563] text-[18px] mt-[10px]">Equipment List</h3>
                </div>
                    ...
                    <table
                        ...
                        <thead class=" bg-[#e6e6e6]">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-left manrope-medium text-[#3D3D3D] font-medium text-[15px]">Equipment Name</th>
                                ...
                                <th scope="col" class="px-6 py-3 text-center manrope-medium text-[#3D3D3D] font-medium text-[15px]">Plant Name </th>
                                <th scope="col" class="px-6 py-3 text-center manrope-medium text-[#3D3D3D] font-medium text-[15px]">Equipment Type</th>
                                <th scope="col" class="px-6 py-3 text-left manrope-medium text-[#3D3D3D] font-medium text-[15px]">Mapped To</th>
                                    ...
                                    <div class="dot-drop absolute bg-white tab-shadow rounded-md hidden top-[50px] right-[60px] w-[170px] p-[10px] z-[8]">
                                        <ul>
                                            <li class="py-[5px]"><a href="#" class="flex manrope-regular text-[#344563] font-normal text-[15px]">
                                                    <img src="{{ asset('admin-theme/assets/images/edit-opt.png') }}" class="w-[16px] mr-[11px] object-contain" onclick="toggleModale()">
                                                    <p>Edit</p>
                                                </a></li>
                                            <li class="py-[5px]"><a href="#" class="flex manrope-regular text-[#344563] font-normal text-[15px]">
