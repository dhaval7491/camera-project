    ...
    <ul class="list-unstyled">
        ...
        <li
            ...
            <a href="{{ route('equipments.index') }}" class="border-l-[2px] border-l-solid border-l-transparent">
                ...
                <p class="manrope-medium text-[12px] text-[#344563] text-center">Equipment</p>
            </a>
        </li>
        <li
            class="mx-[7px] my-[10px] p-[6px]  hover:bg-[#f1f1f1]  rounded-r-[5px] ">
            <a href="{{ route('alerts.index') }}" class="border-l-[2px] border-l-solid border-l-transparent">
                <img src="{{ asset('admin-theme/assets/images/alerts.png')}}" class="w-[20px] my-0 mx-auto mb-[2px] mt-[-18px]">
                <p class="manrope-medium text-[12px] text-[#344563] text-center">Alerts</p>
            </a>
        </li>
        <li
            class="mx-[7px] my-[10px] p-[6px]  hover:bg-[#f1f1f1]  rounded-r-[5px] ">
        ...
        <li
            ...
            <a href="{{ route('mappings.index')}}" class="border-l-[2px] border-l-solid border-l-transparent">
                ...
                <p class="manrope-medium text-[12px] text-[#344563] text-center">Mapping</p>
            </a>
        </li>
        <li
            class="mx-[7px] my-[10px] p-[6px]  hover:bg-[#f1f1f1]  rounded-r-[5px] ">
            <a href="{{ route('trackables.index') }}" class="border-l-[2px] border-l-solid border-l-transparent">
                <img src="{{ asset('admin-theme/assets/images/contractor.png')}}" class="w-[20px] my-0 mx-auto mb-[2px] mt-[-18px]">
                <p class="manrope-medium text-[12px] text-[#344563] text-center">Trackable</p>
            </a>
        </li>
        <li
            class="mx-[7px] my-[10px] p-[6px]  hover:bg-[#f1f1f1]  rounded-r-[5px] ">
            <a href="ai-model.html" class="border-l-[2px] border-l-solid border-l-transparent">
                <img src="{{ asset('admin-theme/assets/images/ai.png')}}" class="w-[20px] my-0 mx-auto mb-[2px] mt-[-18px]">
                <p class="manrope-medium text-[12px] text-[#344563] text-center">AI Model</p>
            </a>
        </li>
        <li
            class="mx-[7px] my-[10px] p-[6px]  hover:bg-[#f1f1f1]  rounded-r-[5px] ">
