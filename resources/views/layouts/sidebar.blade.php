<div class="sidebar fixed h-full w-[100px] sidebar-shadow">
    <ul class="list-unstyled">
        <li class="mx-[7px] my-[10px] p-[6px] hover:bg-[#f1f1f1] rounded-r-[5px] {{ request()->routeIs('superadmin.dashboard') ? 'bg-[#f1f1f1] border-l-[2px] border-l-solid border-l-[#437651]' : 'hover:bg-[#f1f1f1]' }}">
        ...
        <li class="mx-[7px] my-[10px] p-[6px] hover:bg-[#f1f1f1] rounded-r-[5px] {{ request()->routeIs('companies.index') ? 'bg-[#f1f1f1] border-l-[2px] border-l-solid border-l-[#437651]' : 'hover:bg-[#f1f1f1]' }}">
        ...
        <li class="mx-[7px] my-[10px] p-[6px] hover:bg-[#f1f1f1] rounded-r-[5px] {{ request()->routeIs('projects.index') ? 'bg-[#f1f1f1] border-l-[2px] border-l-solid border-l-[#437651]' : 'hover:bg-[#f1f1f1]' }}">
        ...
        <li class="mx-[7px] my-[10px] p-[6px] hover:bg-[#f1f1f1] rounded-r-[5px] {{ request()->routeIs('streams.index') ? 'bg-[#f1f1f1] border-l-[2px] border-l-solid border-l-[#437651]' : 'hover:bg-[#f1f1f1]' }}">
        ...
        <li class="mx-[7px] my-[10px] p-[6px] hover:bg-[#f1f1f1] rounded-r-[5px] {{ request()->routeIs('users.index') ? 'bg-[#f1f1f1] border-l-[2px] border-l-solid border-l-[#437651]' : 'hover:bg-[#f1f1f1]' }}">
        ...
        <li class="mx-[7px] my-[10px] p-[6px] hover:bg-[#f1f1f1] rounded-r-[5px] {{ request()->routeIs('analytics.index') ? 'bg-[#f1f1f1] border-l-[2px] border-l-solid border-l-[#437651]' : 'hover:bg-[#f1f1f1]' }}">
        ...
        <li class="mx-[7px] my-[10px] p-[6px] hover:bg-[#f1f1f1] rounded-r-[5px] {{ request()->routeIs('settings.index') ? 'bg-[#f1f1f1] border-l-[2px] border-l-solid border-l-[#437651]' : 'hover:bg-[#f1f1f1]' }}">
