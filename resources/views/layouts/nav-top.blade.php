<nav class="w-full bg-white p-[25px] flex items-center justify-between fixed z-[9]">
    <div class="flex items-center space-x-3">
        <a href="#" class="flex items-center">
            <img src="{{ asset('admin-theme/assets/images/logo.png') }}" alt="Logo" class="h-8">
        </a>
        <div class="pl-[30px]">
            <a href="#" class="inline-block manrope-medium text-[15px] mt-[10px] mr-[10px] text-[#437651] underline">&lt; Back</a>
        </div>
        <div class="relative">
            ...
            <span class="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400">
                <img src="{{ asset('admin-theme/assets/images/search-icon.png') }}" class="w-[20px]">
            </span>
        </div>
    </div>
    <div class="flex items-center space-x-4">
        ...
        <button class="w-[30px] h-[30px] bg-[#FD8C1A] text-white text-[13px] manrope-medium rounded-[20px] flex items-center justify-center" onclick="toggleProfileDropdown(event)">
            RS
            <div class="profile-drop absolute bg-white tab-shadow rounded-md hidden top-[70px] right-[0px] w-[200px] p-[10px] z-[8]">
                <ul>
                    <li class="py-[5px]">
                        <a href="{{ route('account-settings') }}" class="flex text-[#344563] text-[16px] manrope-medium">
