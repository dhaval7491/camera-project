...
class UserDataTable extends DataTable
{
                ...
                return '
                    <ul class="flex justify-start align-items-center">
                        <li class="py-[5px]"><a href="' . route('users.show', $user->id) . '" class="flex manrope-regular text-[#344563] font-normal text-[13px]">
                            <img src="' . asset('admin-theme/assets/images/view.png') . '" class="mt-[4px] w-[16px] h-[16px] mr-[11px] object-contain"></a>
                        </li>
                        <li class="py-[5px]"><a href="javascript:void(0);" class="flex manrope-regular text-[#344563] font-normal text-[15px]" onclick="showEditModal(' . $user->id . ')">
                            <img src="' . asset('admin-theme/assets/images/edit-opt.png') . '" class="mt-[0px] w-[16px] h-[16px] mr-[11px] object-contain"></a>
                        </li>
                        <li class="py-[5px]">
    ...
    {
        return [
            'name' => ['title' => 'Name', 'searchable' => true, 'className' => 'text-left text-[#344563] text-[11px] manrope-regular'],
            'email' => ['title' => 'Email', 'searchable' => true , 'className' => 'text-left text-[#344563] text-[11px] manrope-regular'],
            'company_name' => ['title' => 'Company', 'searchable' => false , 'className' => 'text-left text-[#344563] text-[11px] manrope-regular'],
            'access_level' => ['title' => 'Access Level', 'searchable' => false , 'className' => 'text-left text-[#344563] text-[11px] manrope-regular'],
            'is_active' => ['title' => 'Status', 'searchable' => false , 'className' => 'text-left text-[#344563] text-[11px] manrope-regular'],
