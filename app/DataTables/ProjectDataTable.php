    ...
    protected function buildActionColumn($project)
    {
        return '
            <div class="flex justify-start relative">
                <span><a href="javascript:void(0);" onclick="showEditModal(' . $project->id . ')"><img src="' . asset('admin-theme/assets/images/edit-report.png') . '" class="w-[21px] mr-[20px]"></a></span>
                <span><a href="crane.html"><img src="' . asset('admin-theme/assets/images/live.png') . '" class="w-[23px] mr-[20px]"></a></span>
